...
namespace BugTracker
{
    public partial class frmConsultaBugs : Form
    {
        ...
        private void btnConsultar_Click(object sender, EventArgs e)
        {
            ...
            {
                string idPrioridades = cboPrioridades.SelectedValue.ToString();
            ...
            {
                string idCriticidad = cboCriticidades.SelectedValue.ToString();
            ...
            {
                string strProductos = cboProductos.SelectedValue.ToString();
                strSql += "AND (id_producto=@idProducto)";
                parametros.Add("idProducto", strProductos);
            }
