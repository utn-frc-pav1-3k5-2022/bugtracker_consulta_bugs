...
namespace BugTracker
{
    public partial class frmConsultaBugs : Form
    {
        ...
        //botón clic para abrir el formulario
        ...
        // clic salir de la aplicación
        private void salirToolStripMenuItem_Click(object sender, EventArgs e)
        {
            this.Close();
        }

        //generalizar lógica que completa los ComboBox con datos para que luego pueden ser seleccionados por el usuario
        ...
        //evento Load() (que se dispara al abrir el formulario), y en dicho evento se procederá a cargar los combos de la siguiente forma
